    ...
    <View style={[styles.wrapper, { 
      ...
      >
        ...
        <View style={styles.fieldContainer}>
          <Text style={styles.fieldLabel}>Тикер или название актива</Text>
          <TextInput
            style={styles.inputField}
            value={securityName}
            onChangeText={setSecurityName}
            placeholder="Например: SBER, Газпром, YNDX"
          ...
          onPress={() => {
            void (async () => {
              if (!securityName.trim()) {
                Alert.alert('Ошибка', 'Введите тикер или название актива');
                return;
              }
              ...
              try {
                const asset: any = await apiService.addInvestmentAsset({ 
                  tickerOrName: securityName.trim(),
                  assetType: t,
                  exchange: 'MOEX'
                });
                ...
                Alert.alert('Готово', `${securityName} добавлен в портфель`);
                onBack?.(true);
              } catch (e: any) {
